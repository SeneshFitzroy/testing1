      ...
      <div className="p-4 border-b border-warm-200 dark:border-dark-border">
        <div className="relative mb-4">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2 bg-warm-50 dark:bg-dark-surface border border-warm-200 dark:border-dark-border rounded-lg text-darkwood dark:text-white placeholder:text-warm-400 dark:placeholder:text-white focus:outline-none focus:ring-2 focus:ring-clay/50 focus:border-transparent"
          />
        </div>
