...
export default function Navbar() {
  ...
  const textColor = isLandingPage && !isScrolled
    ...
    : 'text-charcoal dark:text-white hover:text-charcoal dark:hover:text-warm-100'
          ...
          <Link to={user ? (designerOnly ? '/designer-panel' : '/shop') : '/'} className="flex items-center gap-2.5 group shrink-0">
            ...
            <div className="hidden sm:flex flex-col leading-tight">
              ...
              <span className={`text-[10px] -mt-0.5 transition-colors duration-300 ${
                isLandingPage && !isScrolled ? 'text-white/80' : 'text-darkwood/50 dark:text-white'
              }`}>
                ...
                className={`relative flex items-center gap-2 px-3.5 py-2 rounded-xl text-sm font-medium transition-all duration-200 ${
                  isActive(to)
                    ...
                    : isLandingPage && !isScrolled
                      ...
                      : 'text-darkwood/60 dark:text-white hover:bg-warm-100/80 dark:hover:bg-dark-surface/80 hover:text-darkwood dark:hover:text-warm-100'
                }`}
              >
                ...
                <div className="py-1 max-h-64 overflow-y-auto" role="listbox" aria-label="Currency selection">
                  {currencyList.map((cur) => (
                    ...
                    >
                      ...
                      <span className="text-xs text-darkwood/40 dark:text-white">{cur.name}</span>
                    </button>
                  ))}
                </div>
              </DropdownMenu>
                ...
                <div className="relative ml-1" data-profile-menu>
                  ...
                  >
                    ...
                    <ChevronDown className={`h-3.5 w-3.5 transition-transform ${
                      isLandingPage && !isScrolled ? 'text-white/50' : 'text-darkwood/40 dark:text-white'
