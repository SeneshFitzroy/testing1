    ...
    <AnimatePresence>
      ...
      >
        ...
        >
          ...
          <button
            onClick={handleSkip}
            className="absolute top-4 right-4 p-1.5 rounded-lg hover:bg-warm-100 dark:hover:bg-dark-surface text-darkwood/40 dark:text-white transition-colors z-10"
          ...
          <div className="p-8">
            ...
            {/* Language Dropdown */}
            <div className="mb-4">
              <label className="block text-xs font-semibold text-darkwood/60 dark:text-white uppercase tracking-wider mb-2">
                Language
              </label>
              <div className="relative">
                <Globe className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-darkwood/30 dark:text-white" />
                <select
                ...
                <div className="absolute right-3 top-1/2 -translate-y-1/2 pointer-events-none">
                  <svg className="h-4 w-4 text-darkwood/30 dark:text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div className="mb-4">
              ...
              <div className="relative">
                <MapPin className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-darkwood/30 dark:text-white" />
                <select
            ...
            <div className="mb-6">
              ...
              <div className="relative">
                <DollarSign className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-darkwood/30 dark:text-white" />
                <select
