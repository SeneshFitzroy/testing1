        ...
        >
          <div className="relative max-w-2xl mx-auto">
            ...
            <input
              ...
              className="w-full pl-12 pr-4 py-3.5 rounded-xl text-sm bg-neutral-100 dark:bg-dark-surface border border-neutral-200 dark:border-dark-border text-neutral-900 dark:text-warm-100 placeholder-neutral-500 dark:placeholder-warm-500 focus:outline-none focus:ring-2 focus:ring-[#5C3A2A]/30 dark:focus:ring-clay/30 focus:border-[#5C3A2A] dark:focus:border-clay transition-all"
