  ...
  return (
    <div className="min-h-screen bg-[#F8F6F3] dark:bg-dark-bg">
      <div className="max-w-7xl mx-auto px-4 py-8">
        {/* Breadcrumb */}
        <motion.nav
          className="flex items-center space-x-2 text-sm text-darkwood/50 dark:text-warm-400 mb-6"
              ...
              <button
                ...
                className={`flex-1 flex items-center justify-center gap-2 py-2.5 px-4 rounded-lg text-sm font-semibold transition-all ${
                  viewMode === '3d'
                    ...
                    : 'text-darkwood/60 dark:text-warm-400 hover:text-darkwood dark:hover:text-warm-200'
                }`}
              >
          ...
          >
            ...
            <div>
              ...
              <div className="flex items-center space-x-4 mb-2">
                ...
                <span className="text-darkwood/50 dark:text-warm-400">
            ...
            <div className="grid grid-cols-3 gap-4 py-6 border-t border-warm-200 dark:border-dark-border">
              <div className="text-center">
                ...
                <div className="text-xs text-darkwood/50 dark:text-warm-400">{t('product.ordersOver')} {formatPrice(FREE_SHIPPING_THRESHOLD)}</div>
              </div>
              <div className="text-center">
                ...
                <div className="text-xs text-darkwood/50 dark:text-warm-400">{t('product.fullCoverage')}</div>
              </div>
              <div className="text-center">
                <RotateCcw className="h-8 w-8 text-darkwood dark:text-warm-300 mx-auto mb-2" />
                <div className="text-sm font-medium text-darkwood dark:text-warm-100">{t('product.easyReturns')}</div>
                <div className="text-xs text-darkwood/50 dark:text-warm-400">{t('product.thirtyDays')}</div>
              </div>
            </div>
          </motion.div>
        </div>
                ...
                <button
                  ...
                  className={`flex items-center space-x-2 py-4 border-b-2 transition-colors whitespace-nowrap ${
                    activeTab === tab.id
                      ...
                      : 'border-transparent text-darkwood/50 dark:text-warm-400 hover:text-darkwood dark:hover:text-warm-100'
                  }`}
                >
                    ...
                    <div className="space-y-3">
                      {[
                        ...
                        <div key={label} className="flex justify-between">
                          <span className="text-darkwood/50 dark:text-warm-400">{label}:</span>
                  ...
                  <div className="bg-white dark:bg-dark-card rounded-xl p-6 border border-warm-100 dark:border-dark-border">
                    ...
                    <div className="space-y-4">
                      <div>
                        ...
                        <div className="text-sm text-darkwood/50 dark:text-warm-400">{t('product.standardDays')} - {formatPrice(9.99)}</div>
                      </div>
                      <div>
                        <div className="font-medium text-darkwood dark:text-warm-100">{t('product.expressDelivery')}</div>
                        <div className="text-sm text-darkwood/50 dark:text-warm-400">{t('product.expressDays')} - {formatPrice(19.99)}</div>
                      </div>
                      <div>
                        <div className="font-medium text-forest dark:text-forest-light">{t('product.freeDelivery')}</div>
                        <div className="text-sm text-darkwood/50 dark:text-warm-400">{t('product.ordersOver')} {formatPrice(FREE_SHIPPING_THRESHOLD)}</div>
                      </div>
                    </div>
                  </div>
                </motion.div>
