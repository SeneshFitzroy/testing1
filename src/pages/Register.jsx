    ...
    <div className="min-h-screen flex bg-warm-50 dark:bg-dark-bg">
      ...
      <div id="main-content" className="w-full lg:w-7/12 flex items-center justify-center py-10 px-4 sm:px-6 lg:px-8" role="main">
        ...
        >
          ...
          >
            ...
            <div>
              <label className="flex items-start gap-3 cursor-pointer group">
                ...
                <span className="text-xs text-darkwood/60 dark:text-white leading-relaxed">
                  I agree to the{' '}
          ...
          {/* Security Note */}
          <div className="flex items-center justify-center gap-2 text-xs text-darkwood/30 dark:text-white">
