          ...
          {stats.map((stat) => (
            ...
            >
              <div className="flex items-start justify-between mb-3">
                ...
                <span className="text-xs font-medium text-darkwood/50 dark:text-warm-400 bg-white/50 dark:bg-dark-surface/50 px-2 py-1 rounded-full">{stat.change}</span>
              </div>
              <div className="text-3xl font-bold text-darkwood dark:text-warm-100 mb-1">
                {stat.value}
              </div>
              <div className="text-sm text-darkwood/60 dark:text-warm-400 font-medium">
                {stat.label}
              </div>
            </motion.div>
          ))}
              ...
              {recentDesigns.map((design) => (
                ...
                >
                  ...
                  <div className="p-5">
                    ...
                    <div className="flex items-center justify-between text-sm text-darkwood/50 dark:text-warm-400 mb-4">
              ...
              {[
                ...
                <div key={i} className="flex gap-3 p-3 bg-warm-50 dark:bg-dark-surface rounded-xl hover:bg-warm-100 dark:hover:bg-dark-border/50 transition-colors">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-darkwood/50 dark:text-warm-400">{tip.desc}</p>
                  </div>
                </div>
              ))}
            </div>
              ...
              {[
                ...
                <div key={step.num} className={`flex items-center gap-4 p-4 ${step.bgLight} rounded-xl hover:scale-[1.02] transition-all`}>
                  ...
                  <div>
                    ...
                    <p className="text-sm text-darkwood/50 dark:text-warm-400">{step.desc}</p>
                  </div>
