    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-warm-50 dark:bg-dark-bg">
        <div className="text-center">
          ...
          <p className="text-darkwood dark:text-warm-200">Loading designs...</p>
        </div>
      </div>
    )
  }
          ...
          <div className="flex flex-col gap-6">
                  ...
                  <button
                    ...
                    className={`px-4 py-2.5 rounded-xl text-sm font-medium transition-all inline-flex items-center gap-1.5 ${
                      filterStatus === id
                        ...
                        : 'bg-white dark:bg-dark-card text-darkwood/70 dark:text-warm-300 border border-warm-200 dark:border-dark-border hover:border-clay hover:text-clay dark:hover:text-clay'
                    }`}
                  >
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
              ...
              <select
                ...
                className="px-4 py-2.5 rounded-xl text-sm border border-warm-200 dark:border-dark-border bg-white dark:bg-dark-card text-darkwood dark:text-warm-100 focus:ring-2 focus:ring-clay/30 outline-none"
              ...
              <div className="flex items-center gap-2">
                ...
                {filteredDesigns.length > 0 && (
                  <button
                    ...
                    className="px-4 py-2.5 rounded-xl border border-warm-200 dark:border-dark-border text-darkwood/70 dark:text-warm-300 hover:border-clay hover:text-clay hover:bg-clay/5 dark:hover:bg-clay/10 transition-all inline-flex items-center gap-2"
                ...
                <div className="bg-white dark:bg-dark-card rounded-2xl p-10 border border-warm-200 dark:border-dark-border text-center">
                  ...
                  {designs.length === 0 ? (
                    ...
                    <button
                      ...
                      className="inline-flex items-center gap-2 px-4 py-2 bg-warm-100 dark:bg-dark-surface text-darkwood dark:text-warm-200 font-medium rounded-xl hover:bg-warm-200 dark:hover:bg-dark-border transition-all"
                    >
                      Clear filters
                    </button>
                  )}
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-start justify-between gap-3 mb-3">
                        <h3 className="font-semibold text-darkwood dark:text-warm-100 text-sm leading-tight">{design.name}</h3>
              ...
              <div className="bg-white dark:bg-dark-card rounded-2xl border border-warm-200 dark:border-dark-border overflow-hidden shadow-sm">
                ...
                <div className="p-6 sm:p-8 border-b border-warm-200 dark:border-dark-border">
                  ...
                  {selectedDesign.rooms?.length > 0 && (
                    <div className="mt-6">
                      <h4 className="text-sm font-semibold text-darkwood dark:text-warm-200 mb-3 flex items-center gap-2">
                          ...
                          <div key={idx} className="bg-warm-50 dark:bg-dark-surface rounded-xl p-4">
                            ...
                            <div className="flex flex-wrap gap-2">
                              {room.furnitureItems?.map((item, fi) => (
                                <span key={fi} className="px-2.5 py-1 bg-white dark:bg-dark-card rounded-lg text-xs text-darkwood/70 dark:text-warm-300 border border-warm-200 dark:border-dark-border">
                                  {item.name}
                                </span>
                              ))}
                            </div>
                ...
                <div className="p-6 sm:p-8 border-b border-warm-200 dark:border-dark-border bg-amber-50/30 dark:bg-amber-900/5">
                  <h4 className="text-sm font-semibold text-darkwood dark:text-warm-200 mb-2 flex items-center gap-2">
                ...
                <div className="p-6 sm:p-8">
                  <h3 className="text-lg font-bold text-darkwood dark:text-warm-100 mb-4 flex items-center gap-2">
                  ...
                  <div className="space-y-4 mb-6 max-h-72 overflow-y-auto">
                    ...
                    {selectedDesign.comments?.map((c, ci) => (
                      <div key={ci} className="bg-warm-50 dark:bg-dark-surface rounded-xl p-4 border border-warm-100 dark:border-dark-border">
                        ...
                        <p className="text-sm text-darkwood/70 dark:text-warm-300 leading-relaxed">{c.text}</p>
                        {c.rating && (
                  ...
                  <div className="border-t border-warm-200 dark:border-dark-border pt-6">
                    <label className="text-sm font-semibold text-darkwood dark:text-warm-200 mb-2 block">Add your review</label>
                    <textarea
                      value={comment}
